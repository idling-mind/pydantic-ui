...
class User(BaseModel):
    ...
    billing_address: Annotated[
        Address, FieldConfig(label="Billing Address", help_text="Specific help")
    ]
...
async def test_class_config():
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        assert address_config["label"] == "Global Address Label"
        assert address_config["help_text"] == "Global help"
        ...
        assert billing_config["label"] == "Billing Address"  # Overridden
        assert billing_config["help_text"] == "Specific help"  # Overridden
